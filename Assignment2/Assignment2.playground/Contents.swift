...
/*
 allow us to not name the arguments.
 */
/*:
...
/*
 a function taking in 2 integers and returning a T
 */
/*:
...
/*
 a generic type which is determined by what is returned by  transform.
 */
...
/*
 all the neighboring cells of a cell.
 */
/*:
 ## Problem 6:
...
/*
 when using the parameter in the function
 */
...
/*
 take 3 integers and return one integer
 */
/*:
...
/*
 becuase we know which type we will get.
 */
...
/*
 one is optional, the other one isn't.
 */
/*:
...
/*
 returns the number of living cells neighbouring a given cell.
 */
...
/*
 the position to be used to refernce a cell in the grid.
 */
...
/*
 the nextGrid variable represents the next representation of the grid.
 */
/*:
 ## Problem 22:
